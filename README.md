...
1) Built an end-to-end employee attrition prediction pipeline using feature engineering, preprocessing, and cross-validated model comparison.

2) Achieved ROC-AUC of 0.75 and PR-AUC of 0.49, demonstrating strong discrimination on imbalanced data.

3) Optimized classification threshold (0.50 → 0.20) using Precision-Recall analysis, improving recall from 29% to 74% while maintaining 35% precision.

4) Enabled proactive retention strategy by prioritizing high-risk employees based on cost-sensitive decision tuning.
